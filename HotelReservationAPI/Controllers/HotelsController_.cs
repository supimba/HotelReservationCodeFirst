...
{
    public class HotelsController_ : ApiController
    {
        private DatabaseContext db = new DatabaseContext();

        // GET: api/Hotels -> deprecated
/*  
         public IQueryable<Hotel> GetHotels()
        {
            return db.Hotels.Include(r => r.Rooms);
        }
*/

        // GET: api/Hotels
        public IList<HotelDetailsDto> GetHotels()
        {

            return db.Hotels.Select(h => new HotelDetailsDto()
            {
                Name = h.Name,
